...
class QTable:
    ...
    def update(self, state, action, next_state, reward):
        ...
        discounted_next_q = gamma * max([self.get(next_state, a) for a in [0, 1, 2]])
...
def get_arguments():
    ...
    parser.add_argument('--env_name', default='Acrobot-v1', help='Game name')
    ...
    parser.add_argument('--evaluation_step', type=int, default=5000)
    parser.add_argument('--max_tryout', type=int, default=1000)
